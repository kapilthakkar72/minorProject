...
def generateQueryForRetail(commodity,year,state):
	return "Select r.date,r.price,r.unitofprice from retailpricedata as r, center as c, states as s, variety as v, commodity as co where s.state ='"+state+"' and s.statecode = c.statecode and c.centercode = r.centercode and co.commodityname = '" + commodity + "' and co.commoditycode = v.commoditycode and v.commqualitycode = r.commqualitycode"
